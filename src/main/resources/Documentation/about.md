This plugin is a Kafka implementation of the [broker api interface](https://github.com/GerritForge/events-broker)
...
Create the `$GERRIT_SITE/etc/@PLUGIN@.config` with the
