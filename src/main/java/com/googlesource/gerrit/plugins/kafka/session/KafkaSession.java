...
public final class KafkaSession {
  ...
  public void connect() {
    ...
    /* Need to make sure that the thread where the connection is running is using the correct class loader
     * otherwize you can endup with hard to debug ClassNotFoundExceptions
     */
