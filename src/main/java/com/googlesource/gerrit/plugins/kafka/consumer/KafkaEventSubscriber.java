...
package com.googlesource.gerrit.plugins.kafka.consumer;
...
import com.googlesource.gerrit.plugins.kafka.broker.KafkaConfiguration;
...
public class KafkaEventSubscriber {
  ...
  private java.util.function.Consumer<SourceAwareEventWrapper> messageProcessor;
  ...
  public void subscribe(
      String topic, java.util.function.Consumer<SourceAwareEventWrapper> messageProcessor) {
    try {
      logger.atInfo().log(
  ...
  public java.util.function.Consumer<SourceAwareEventWrapper> getMessageProcessor() {
